...
if __name__ == '__main__':
    ...
    def supports_color():
        ...
        if not supported_platform or not is_a_tty:
            return False
        return True
    print(f"Does this system support colour? {'yes' if supports_color() else 'no'}")

    raise Exception(f'{bcolors.UNDERLINE}{bcolors.FAIL}hi! {bcolors.BOLD} this shouldn\'t be coloured')
